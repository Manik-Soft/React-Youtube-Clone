...
const VideoPage = () => {
  ...
  const [desc, setDesc] = useState(
    <>
      <p>➟ BINGE MY MEMES: https://bit.ly/BingeMemes</p>
      <br />
      <p>
        ➟ Create Eye-Catching Thumbnails in 60 Seconds:
        https://bit.ly/EasyThumbnail
      </p>
      <br />
      <p>
        ➟ Credits (Please check out the creators of these clips, without them
        these kinds of videos won't exist): https://pastebin.com/K7kPeY4L
      </p>
      <br />
      <p>
      ...
      <div className="videoPageLeft">
        ...
        <div className="videoPageDesc">
          ...
          <div className="videoPageVideoDesc">
            {readMore ? desc : desc.substring(0, 20)}
