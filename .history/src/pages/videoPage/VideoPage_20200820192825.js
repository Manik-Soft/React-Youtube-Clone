...
const VideoPage = () => {
  ...
  return (
    <div className="videoPage">
        ...
        <div className="videoPageVideoInfo">
          ...
          <div className="videoPageDetails">
            <p>
              ...
              {format(videoInfo.snippet?.publishedAt)}
            </p>
            <div className="videoPageButtons">
              <ThumbUp className="buttonIcon" />{" "}
              {videoInfo.statistics?.likeCount}
              <ThumbDown className="buttonIcon" />{" "}
      ...
      <UpNext title={videoInfo.snippet?.localized?.title} tag={videoInfo.snippet?.tags[0]}/>
    </div>
  );
};
